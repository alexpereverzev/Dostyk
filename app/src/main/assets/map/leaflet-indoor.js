...
L.Indoor = L.Layer.extend({
    ...
    addData: function(data, opt) {
        ...
        features.forEach(function(part) {
            ...
            var level = options.getFeatureLevel(part);
            ...
            var featureGroup = options.getFeatureGroup(part);
...
L.Control.Level = L.Control.extend({
    ...
    onAdd: function(map) {
        ...
        for (i = levels.length - 1; i >= 0; i--) {
            ...
            levelBtn.innerHTML = "<a class=\"ibecom-level-button-text\">"+originalLevel+"</a>";
