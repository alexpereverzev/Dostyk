...
package litebonus.dostyk.widget;
...
public class ViewDragHelper {
    ...
    private static final int BASE_SETTLE_DURATION = 512; // ms
     ...
     * The callback's {@link flacon.ibecon.ru.flaconcontent.widget.ViewDragHelper.Callback#onEdgeTouched(int, int)} and
     * {@link flacon.ibecon.ru.flaconcontent.widget.ViewDragHelper.Callback#onEdgeDragStarted(int, int)} methods will only be invoked
     ...
     * but {@link flacon.ibecon.ru.flaconcontent.widget.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)} will not be asked permission to
     * capture this view.
     *
     ...
     * The child order is determined using {@link flacon.ibecon.ru.flaconcontent.widget.ViewDragHelper.Callback#getOrderedChildIndex(int)}.
     *
     * @param x X position to test in the parent's coordinate system
     * @param y Y position to test in the parent's coordinate system
