...
//	BASIC_INFO("basic_info", Type.READ),
	...
	private Permissi(String value, SessionAuthorizationType type)
	{
		mValue = value;
		mType = type;
	}
	...
	public static Permissi findPermission(String value)
	{
		for (Permissi p : Permissi.values()) {
